...
# get_seasonal_chart_data,get_seasonal_chart_data2, get_chart_data
...
def get_chart_data(id,opp_date,symbol,daysOut,years,zero_last_year,appserver_token):
    ...
    appserver_url = "https://app1stage.trxstat.com"
    ...
    # print('-line 114 create_report.py-----------------------urlY=',urlY)
...
def get_seasonal_chart_data(id,symbol,years,start_date,token):
    urlC = config.appserver_url+'/consolidated_seasonal_chart2/'+str(id)+'/'+symbol+'/'+str(years)+'/'+start_date+'/'+start_date+'?token='+token
...
#------------------------------------------------------------------------------------------------
# this version includes chart_start_date and opp_start_date
...
def generate_report(appserver_token,financial_group_id,date1,days_hold,symbol,years,zero_last_year,base_year,category):
    ...
    with open("test_old_articles.html", "w") as file:
        file.write(html_table+content)
...
if __name__ == '__main__':
    ...
    #  b'{"action": "seasonal_report", "id": "10", "symbol": "CA30Y", "date": "2025-08-18", "days_hold": "49", "years": "8", "base_year": "2025", "zero_last_year": "True", "userid": "0", "request_datetime": "2025-08-17T15:29:44", "category": "37", "user_level": "0", "title": "-", "slug": "-"}'
...
#----------------------------------------------------------------------------
    ...
    cdata=get_chart_data(resource_id,date1,symbol,days_hold,years,zero_last_year,appserver_token)
