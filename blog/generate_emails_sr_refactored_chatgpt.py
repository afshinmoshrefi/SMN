    ...
    content_row += f""" 
                <tr >
                    ...
                    <p style='font-family: courier; font-size: 10px;'>
                        ...
                        &copy; Copyright Wave Analytics International LLC dba TradeWave ("TradeWave"). All Rights Reserved Worldwide.
    ...
    content_row += f""" 
                ...
                <tr>
                    <td  colspan="2" width='{header_td_width}' height="50px" align="left" style='background-color:transparent;padding-left:5px;padding-top:10px;border-top:1px solid black'>
                        ...
                        <p style='font-family: Arial, sans-serif; font-size: 14px;'>
                            Welcome to today&apos;s &quot;Top 10 Wave Opportunities&quot; report.  We&apos;ve sorted through hundreds of billions of potential trades over 10 different markets to find you the best waves starting on today&apos;s date.
                        </p>

                        <p style='font-family: Arial, sans-serif; font-size: 14px;'><b>
                        Today&apos;s top wave is a {dfe['Direction'].iloc[0]} opportunity on the {dfe['company'].iloc[0]}.  For the past {dfe['years'].iloc[0]} years, had you bought on {date1_formatted} and sold on {date2_formatted}, your average gain would have been {dfe['avg_profit'].iloc[0]}%.</b>
...
if __name__ == '__main__':
    ...
    if num_subscribers > 0:
        ...
        d,h,m = future_date_hour_min(30) # get time 5 minute from now
