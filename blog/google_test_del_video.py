...
# args= Namespace(auth_host_name='localhost', auth_host_port=[8080, 8090], category='27', description='example youtube description', file='./tradewave_videos/2023-10-05/youtube_NUE_video_l1_2023-10-05.mp4', keywords='surfing,trading', logging_level='ERROR', noauth_local_webserver=True, privacyStatus='public', title='My first example title')

  thumbnail_url  = "https://tradewave.ai/wp-content/uploads/p/thumbnails/facebook/2023/2023-10-06/25-year-tradewave-report-nucor-nue-2023-10-06-to-2023-12-25.jpg"
  thumbnail_path = "/var/www/html/wp-content/uploads/p/thumbnails/facebook/2023/2023-10-06/25-year-tradewave-report-nucor-nue-2023-10-06-to-2023-12-25.jpg"
  ...
  args = argparse.Namespace(
    ...
    file='./tradewave_videos/2023-10-05/youtube_NUE_video_l1_2023-10-05.mp4',
