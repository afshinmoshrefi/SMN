...
def load_data_for_email():
    ...
    dfe = dfe[['resource_id','row_pos','Symbol','Date', 'DaysOut', 'Direction', 'Sharpe Ratio', 'Date2','Cumulative Return', 'Avg Profit', 'Trend Long', 'Trend Short','post_title', 'company', 'opp_slug', 'bar_img', 'cum_img', 'sea_img','top_10_list_png_m', 'top_10_list_png_d']]
    #################################################################
