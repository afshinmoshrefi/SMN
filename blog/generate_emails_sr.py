...
def content_footer(desktop_or_smartphone):
    ...
    content_row += f""" 
                <tr >
                    <td  colspan="2"  height="50px" align="left" style='background-color:transparent;padding-left:5px;padding-top:10px;border-top:1px solid black'>


                    <p style='font-family: Arial, sans-serif; font-size: 12px;'>
                            [IMPORTANT:  This is NOT investment advice.  These waves are “history lessons” of how each security has performed over a specific date range over the past 8-10 years.  Past performance does not ensure future results.  Consult with your financial advisor before taking any trades, and never trade money you can’t afford to lose.]
                    </p>

                    <p style='font-family: Arial, sans-serif; font-size: 14px;'>
                        For details on any of the waves above, click the image and see the full report online, or go to https://TradeWave.AI/top10/ for the current list of today&apos;s Top 10 Wave Trades.

                        If you found this report valuable, please help us spread the word by forwarding this email to a trading buddy or someone else who would benefit from it.

                        Thanks for subscribing to the Top 10 Wave Trades!  See you again soon!
                        <br><br>
                        Trade the Wave,
                        <br><br>
                        Afshin
                    ...
                    <p style='font-family: courier; font-size: 10px;'>

                        &copy; Copyright Tara Data Research LLC dba TradeWave ("TradeWave"). All Rights Reserved Worldwide.

                        No Investment Advice Provided

                        Financial market trading is not appropriate for everyone. While there is a potential for large rewards, there is also a substantial risk of loss associated with trading. Losses can and will occur. Don&apos;t trade with money you can&apos;t afford to lose. This is neither a solicitation nor an offer to buy/sell stocks, options, futures, and/or currencies. No system or methodology has ever been developed that can guarantee profits or ensure freedom from losses. No representation or implication is being made that using these methodologies or systems or the information in this message will generate profits or ensure freedom from losses.

                        CFTC Rule 4.41 states that any claims of results may be based on simulated or hypothetical performance results that have certain inherent limitations. Unlike the results shown in an actual performance record, these results may not represent actual trading. Also, for trades that have not actually been executed, results may have under-or over-compensated for the impact, if any, of certain market factors, such as lack of liquidity. Simulated or hypothetical trading programs in general are also subject to the fact that they are designed with the benefit of hindsight. No representation is being made that any account will or is likely to achieve profits or losses similar to these being shown.
...
#-----------------------------------------------------------------------------------------------------
# def content_header(desktop_or_smartphone,dfe):



#     date1_obj       = datetime.datetime.strptime(dfe['Date'].iloc[0], '%Y-%m-%d')
#     date1_formatted = date1_obj.strftime('%b %d')
#     date2_obj       = datetime.datetime.strptime(dfe['Date2'].iloc[0], '%Y-%m-%d')
#     date2_formatted = date2_obj.strftime('%b %d')
...
#                         <p style='font-family: Arial, sans-serif; font-size: 14px;'>
#                             Welcome to today&apos;s &quot;Top 10 Wave Trades&quot; report.  We&apos;ve sorted through hundreds of billions of potential trades over 10 different markets to find you the best waves starting on today&apos;s date.
#                         </p>

#                         <p style='font-family: Arial, sans-serif; font-size: 14px;'><b>
#                         Today&apos;s #1 wave is a {dfe['Direction'].iloc[0]} opportunity on the {dfe['company'].iloc[0]}.  For the past {dfe['years'].iloc[0]} years, had you bought on {date1_formatted} and sold on {date2_formatted}, your average gain would have been {dfe['avg_profit'].iloc[0]}%.</b>

#                         </p>

#                         <p style='font-family: Arial, sans-serif; font-size: 14px;'>
#                         Check out the rest of the Top 10 below, and click on any of the thumbnails to get a full report on the trade.  (If you do not see any images, make sure to <a target='_blank' href='https://www.whitelist.guide'>whitelist</a> us with your email provider and allow images.)
#                         </p>
...
#     header_td_width = '720px' if desktop_or_smartphone == 'desktop' else '360px'
#     today_date = datetime.datetime.now().strftime("%Y-%m-%d")
...
#                     <td width="520px" height="100px" align="left" style='vertical-align:middle;background-color:transparent'> 
#                         <div style="font-size: 18px; font-weight: bold;">Daily Top 10 Wave Trades</div>
#                         <div style="font-size: 14px;">Tara Data Research</div>
#                         <div><a style='color:black;font-weight:bold;font-size:1.1rem' href='https://tradewave.ai'>TradeWave.AI</a></div>
#                     </td>
#                 </tr>
...
#                     <td colspan="2" width="{header_td_width}" height="50px" align="left" style='background-color:transparent;padding-left:5px;padding-top:10px;border-top:1px solid black'>
#                         <p style='font-family: Arial, sans-serif; font-size: 14px;'>
#                             Hello, and welcome to today’s <strong>Top 10 Wave Patterns Report! </strong>Our software analyzed over a trillion data points to bring you these top-ranked patterns with high Sharpe ratios. These patterns showcase times when securities have shown a high probability of repeating specific price movements.
#                         </p>
...
#                         <p style='font-family: Arial, sans-serif; font-size: 14px;'><b>
#                         Today’s top pick is a {dfe['Direction'].iloc[0]} opportunity on {dfe['company'].iloc[0]}. If you had bought on {date1_formatted} and sold on {date2_formatted} over the past {dfe['years'].iloc[0]} years, you would have seen an average gain of {dfe['avg_profit'].iloc[0]}%.
#                         </b></p>

#                         <p style='font-family: Arial, sans-serif; font-size: 14px;'>
#                             Check out the full Top 10 list below! Click on any thumbnail to explore a detailed report with charts, stats, and insights that make each wave unique. (If images aren’t loading, please <a target='_blank' href='https://www.whitelist.guide'>whitelist us</a> to ensure you’re not missing any visual insights.)
#                         </p>

#                         <p style='font-family: Arial, sans-serif; font-size: 14px;'>
#                             Ready to dive deeper? <a href='https://tradewave.ai/register/?lid=1' target='_blank'>Sign up for free</a> to unlock more features, or <a href='https://tradewave.ai/webinars' target='_blank'>join our next webinar</a> to learn how TradeWave can enhance your trading strategy!
#                         </p>
#                     </td>
#                 </tr>
#             """
...
#     return content_row
#-----------------------------------------------------------------------------------------------------
# chatgpt version without webinar
#-----------------------------------------------------------------------------------------------------
def content_header(desktop_or_smartphone, dfe):
    import datetime
    ...
    content_row += f"""
                ...
                <tr>
                    <td colspan="2" width="{header_td_width}" height="50px" align="left" style='background-color:transparent;padding-left:5px;padding-top:10px;border-top:1px solid black'>
                        <p style="font-family: Arial, sans-serif; font-size: 14px;">
                            Here&#39;s your Daily Top 10 update. Today&#39;s top pick is a {dfe['Direction'].iloc[0]} trade on {dfe['company'].iloc[0]}.<br>
                            View the full list on our <a href="{config.wordpress_url}top10/">Top 10 page</a> or browse by market segment.<br>
                            You can also <a href="https://tradewave.ai/top-10-opportunities-for-each-market-{today_date}/">
                                view Top 10 lists for each market
                            </a> — stocks, ETFs, futures, bonds, and more, giving you dozens of extra opportunities for {today_date}.
                        </p>
                    </td>
                </tr>
            """
...
#     return content
#-----------------------------------------------------------------------------------------------------
# chatgpt version fixing 2 column email on outlook
#-----------------------------------------------------------------------------------------------------
# def create_final_email(dfe):
#     cells_dict = create_all_content_cells(dfe)

#     # Use nested tables to create a two-column layout without relying on CSS
#     content_rows = ''
#     for i in range(0, 10, 2):  # Increment by 2 for each row to pair columns
#         content_rows += f"""
#             <tr>
#                 <td align="center" style="width: 50%; padding: 5px; vertical-align: top;">
#                     {cells_dict[i]}
#                 </td>
#                 <td align="center" style="width: 50%; padding: 5px; vertical-align: top;">
#                     {cells_dict[i+1] if i+1 < len(cells_dict) else ''}
#                 </td>
#             </tr>
#         """

#     # Create the final email HTML
#     email_content = f"""
#         <!DOCTYPE html>
#         <html>
#         <head>
#             <title>TradeWave Top 10 Daily Email</title>
#         </head>
#         <body>
...
#                 <tr>
#                     <td align="center">
#                         <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 720px; background-color:#ffffff;">
#                             {content_rows}
#                         </table>
#                     </td>
#                 </tr>
...
#     with open("/var/www/html/wp-content/test.html", "w") as file:
#         file.write(email_content)

#     return email_content
#-----------------------------------------------------------------------------------------------------
# second version by chatGPT
#-----------------------------------------------------------------------------------------------------
def create_final_email(dfe):
    cells_dict = create_all_content_cells(dfe)

    # Content rows for two-column layout by default
    content_rows = ''
    for i in range(0, 10, 2):  # Increment by 2 for each row to pair columns
        content_rows += f"""
            <tr>
                <td class="content-cell" align="center" style="width: 50%; padding: 10px; vertical-align: top;">
                    {cells_dict[i]}
                </td>
                <td class="content-cell" align="center" style="width: 50%; padding: 10px; vertical-align: top;">
                    {cells_dict[i+1] if i+1 < len(cells_dict) else ''}
    ...
    # Create the final email HTML with mobile-specific adjustments
    email_content = f"""
        <!DOCTYPE html>
        <html>
        <head>
            <title>TradeWave Top 10 Daily Email</title>
            <style>
                /* Media query to switch to single-column layout on mobile */
                @media only screen and (max-width: 600px) {{
                    .content-table {{ width: 100% !important; }}
                    .content-cell {{ width: 100% !important; display: block !important; }}
                }}
            </style>
        </head>
        <body>
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#f5f5f5;">
                ...
                <!-- Two-Column Content Section by Default -->
                <tr>
                    <td align="center">
                        <table class="content-table" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 720px; background-color:#ffffff;">
                            {content_rows}
                        </table>
                    </td>
                </tr>
...
if __name__ == '__main__':
    ...
    if today_date[5:] == '01-01' or today_date[5:] == '07-04' or today_date[5:] == '12-25':
        print('Today is a holiday - no emails will be sent') 
        exit()
    ...
    if num_subscribers > 0:
        ...
        subject       = f"📈 {day_of_week}'s Top10 Wave Trades | {today_formatted}"

        from_name     = 'TradeWave'
        from_email    = 'help@tradewave.ai'
        ...
        d,h,m = future_date_hour_min(50) # get time 5 minute from now

        # print('d,h,m = ',d,h,m)

        response=schedule_campaign(campaign_id,d,h,m)
