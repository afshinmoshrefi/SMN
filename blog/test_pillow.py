...
#-------------------------------------------------------------------------------
    ...
    td = {
        ...
        'rect_y_pct':0.925, # top:0.075  center:0.5 bottom:0.925
...
def create_socialmedia_thumbnail(sm,resource_id,date,symbol,days,dir,avg_gain,years,title_pre,category = config.category_date_range_report):
...
if __name__ == '__main__':
    ...
    png_filename = 'average-seasonal-chart-10-year-seasonal-report-arca-mexico-mxy-2023-01-02-to-2023-02-17.png'

    source_img = Image.open(png_filename).convert("RGBA")
